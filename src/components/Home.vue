    ...
    <div class="vacate">
      ...
      <header class="vacate__header">
        <h1 class="heading-primary">
          ...
          <span class="heading-primary--sub">Vacate yourself before you leave the browser</span>
        </h1>
      </header>
      <multiselect
      ...
      <div v-if="display">
        <app-website v-for="website in selectedWebsites" :key="website.name" :website="website" >
        </app-website>
      </div>
    </div>
</template>
